    ...
    <div className="min-h-screen pt-24 bg-white flex items-center justify-center container mx-auto px-6">
      ...
      >
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold text-accent-charcoal">Reset Password</h1>
          <p className="text-accent-charcoal/60 text-sm mt-2">Enter your new password below.</p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-2">
            <label className="text-xs font-bold text-accent-charcoal/40 uppercase tracking-widest">New Password</label>
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold text-accent-charcoal/40 uppercase tracking-widest">Confirm Password</label>
            <div className="relative">
              <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-accent-charcoal/30 w-5 h-5" />
              <input 
                type="password" 
